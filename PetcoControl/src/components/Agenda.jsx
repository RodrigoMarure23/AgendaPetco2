...
const Agenda = () => {
  ...
  const getInfoData = async () => {
    try {
      const res = await axios.post('https://app.petco.com.mx/recuperaEmpleado', { noEmpleado: localStorage.numeroEmpleado }, {
        headers: {
          "x-api-pe-wss": "681ae67106810684b039e48aa9aa2c6d440ef1867e71f96bb98515a104c77c5b", Authorization: `Bearer ${localStorage.token}`
        }
      })
      const user = res.data
      console.log("res", res)
  ...
  const getdata = async () => {
    try {
      ...
      const respuesta = await axios.get(`https://petcomplete.petco.com.mx/asistencias/empleadosSucursal/${localStorage.getItem("numeroTienda")}`)
